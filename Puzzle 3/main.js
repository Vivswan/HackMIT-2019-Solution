	    ...
	    _createClass(Cell, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'td',
	                { className: 'square', key: this.props.num },
	                _react2.default.createElement('input', {
	                    type: 'text',
	                    value: this.props.letter,
	                    maxLength: '1',
	                    onChange: function onChange(e) {
	                        return _this2.props.onLetterUpdate(_this2.props.num, e.target.value);
	                    },
	                    title: this.props.hoverText,
	                    style: this.props.hoverText ? { "fontWeight": "bold" } : {}
	                })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Puzzle = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Puzzle = function (_Component) {
	    ...
	    function Puzzle(props) {
	        ...
	        _this.state = {
	            letters: Array(_data.gridConfig.maxVal).fill("")
	        };
	        _this.onCellUpdate = _this.onCellUpdate.bind(_this);
	        return _this;
	    }
	
	    _createClass(Puzzle, [{
	        key: 'onCellUpdate',
	        value: function onCellUpdate(num, letter) {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_Grid2.default, {
	                        nRows: _data.gridConfig.nRows,
	                        nCols: _data.gridConfig.nCols,
...
/***/ function(module, exports, __webpack_require__) {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'tr',
	                        null,
	                        this.props.cells.map(function (cellNum, idx) {
	                            return _react2.default.createElement(_Cell2.default, {
	                                onLetterUpdate: _this2.props.onCellUpdate,
	                                num: cellNum,
	                                key: cellNum,
	                                letter: _this2.props.letters[cellNum],
	                                hoverText: _this2.props.dataLoc === idx ? _this2.props.data : ""
	                            });
	                        })
	                    )
	                )
	...
	var Words = function (_Component2) {
	    _inherits(Words, _Component2);
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'tbody',
	                    null,
	                    this.props.clues.map(function (clue, index) {
	                        return _react2.default.createElement(
	                            'tr',
	                            { key: index },
	                            _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'td',
	                                { key: 2 },
	                                _react2.default.createElement(Word, {
	                                    cells: clue.cells,
	                                    onCellUpdate: _this4.props.onCellUpdate,
	                                    letters: _this4.props.letters,
	                                    data: clue.data,
	                                    dataLoc: clue.dataLoc
	                                })
	                            )
	                        );
	                    })
